...
<div class="container">
    <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto">
        <h2 class="text-center">Register Your Child Here</h2>
        <p class="text-center">Please fill this form to register your child's account.</p>
        <form action="registerChild.php" method="post">
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-primary" value="Submit" name="registerChild">
